...
.wip { color:var(--status-over); font-weight:700; letter-spacing:0.08em; vertical-align:middle;
  border:2.5px solid var(--status-over); border-radius:var(--radius-sm); padding:3px 12px; font-size:24px;
  margin-left:6px; }
