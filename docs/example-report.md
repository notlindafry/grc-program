...
**After the funded plan** (Deploy phishing-resistant MFA (FIDO2 passkeys) across all consoles and Enforce SSO via the IdP across legacy consoles): projected **within** appetite, at **$391k–$1.5M** residual. Conditional on the funded plan executing.
